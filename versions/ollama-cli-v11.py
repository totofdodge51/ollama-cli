#!/usr/bin/env python3
"""
Ollama CLI v11 - Assistant LLM interactif amélioré avec création de projet multi-fichiers.
"""
...
class OllamaCLI:
    ...
    def _get_header_panel(self):
        ...
        return Panel(Text(ASCII_LOGO, style=self.theme["logo"], justify="center"), title="Ollama CLI v11", subtitle=subtitle, border_style=self.theme["header_border"])
    ...
    def _get_help_content(self):
        help_text = """# Aide de Ollama CLI v11
- `/quit, /exit, /q`: Quitter.
...
def main():
    parser = argparse.ArgumentParser(description="Ollama CLI v11 - Assistant de code interactif avec création de projet.")
